...
class HomeController < ApplicationController
    ...
    def query_last_sync 
        lab  = params[:lab_name]
        data = "0"
        res = Speciman.find_by_sql("SELECT * FROM specimen where substr(tracking_number,1,3)='X#{lab}' AND substr(tracking_number,1,4)!='XNDH' ORDER BY id DESC LIMIT 1") if lab == 'ND'
